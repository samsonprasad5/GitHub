...
document.querySelectorAll('.toggle-btn[data-name]').forEach(button => {
  button.addEventListener('mouseover', (e) => {
      ...
      // Adjust popup position to ensure it stays in the viewport
          ...
          tooltip: {
              callbacks: {
                  label: function(tooltipItem) {
                      ...
                      return departmentNames[tooltipItem.dataIndex] + ': ' + tooltipItem.raw + ' departments';
                  }
              }
          }
      }
...
document.getElementById('logout').addEventListener('click', () => {
  // Add your logout logic here, for example, clearing session data
  alert('Logged out!');
});
=======
...
>>>>>>> 367e483707004cebd9bab5fd48efe33653563c6d
